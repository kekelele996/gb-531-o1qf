...
func NewSnapshot(node model.ProcessNode, scenario model.DeviationScenario, safeguards []model.Safeguard, reference time.Time, failureWindowDays int) Snapshot {
	...
	snapshot := Snapshot{
		...
		FailureWindowDays: failureWindowDays,
		Node: SnapshotNode{
